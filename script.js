...
const upArrowii = document.getElementById('upArrowii')
const leftArrowii = document.getElementById('leftArrowii')
const rightArrowii = document.getElementById('rightArrowii')
...
leftArrowii.addEventListener('touchend', function(){
    if(!enemy.dead){
